...
class Window(PyQt5.QtWidgets.QWidget):
    ...
    def setCameraIcon(self):
        self.CameraLabel.setPixmap(PyQt5.QtGui.QPixmap(f"{current_directory}/icons/camera.ico"))
    ...
    def drop_file_layout_single(self):
        ...
        self.DropIcon.setPixmap(PyQt5.QtGui.QPixmap(f"{current_directory}/icons/drop_file.ico"))
        self.DropIcon.setAlignment(PyQt5.QtCore.Qt.AlignHCenter | PyQt5.QtCore.Qt.AlignTop)
        ...
        self.DropLabel_single.setAlignment(PyQt5.QtCore.Qt.AlignHCenter | PyQt5.QtCore.Qt.AlignBottom)
    ...
    def drop_file_layout_multi(self):
        ...
        self.DropLabel.setAlignment(PyQt5.QtCore.Qt.AlignHCenter | PyQt5.QtCore.Qt.AlignBottom)
    ...
    def make_Left_Layout(self):
        ...
        self.LeftArea.setAlignment(PyQt5.QtCore.Qt.AlignHCenter | PyQt5.QtCore.Qt.AlignVCenter)
    ...
    def make_Right_layout(self):
        self.right_layout = PyQt5.QtWidgets.QStackedLayout(objectName = 'RightArea')

        self.right_label = PyQt5.QtWidgets.QLabel('Перевод', objectName = 'RightLabel')
        self.right_label.setFixedSize(720, 480)
        self.right_label.setAlignment(PyQt5.QtCore.Qt.AlignHCenter | PyQt5.QtCore.Qt.AlignVCenter)
    ...
    def get_stream_button(self):
        stream_button = PyQt5.QtWidgets.QPushButton('Прямой эфир', objectName = 'MenuButton')
        stream_button.setToolTip('Переводит язык жестов в текст в прямом эфире')
    ...
    def get_mono_button(self):
        mono_button = PyQt5.QtWidgets.QPushButton('Однознаковый', objectName = 'MenuButton')
        mono_button.setToolTip('Обрабатывает видео содержащие в себе не более одного знака РЖЯ')
    ...
    def get_multi_button(self):
        multi_button = PyQt5.QtWidgets.QPushButton('Многознаковый', objectName = 'MenuButton')
        multi_button.setToolTip('Обрабатывает видео содержащие в себе более одного знака РЖЯ')
    ...
    def create_menu_layout(self):
        ...
        logo_label = PyQt5.QtWidgets.QLabel('Выберите режим перевода:', objectName = 'LogoLabel')
        ...
        menu_layout.setAlignment(PyQt5.QtCore.Qt.AlignVCenter | PyQt5.QtCore.Qt.AlignLeft)
    
    def left_history_area(self):
        self.left_history_layout = PyQt5.QtWidgets.QVBoxLayout(objectName = 'HistoryArea')
        self.left_history_layout.setAlignment(PyQt5.QtCore.Qt.AlignTop | PyQt5.QtCore.Qt.AlignHCenter)
        tool_label = PyQt5.QtWidgets.QLabel('источник', objectName = 'HistoryTitleToolLeft')
    ...
    def right_history_area(self):
        self.right_history_layout = PyQt5.QtWidgets.QVBoxLayout(objectName = 'HistoryArea')
        self.right_history_layout.setAlignment(PyQt5.QtCore.Qt.AlignTop | PyQt5.QtCore.Qt.AlignHCenter)
        tool_label = PyQt5.QtWidgets.QLabel('вывод', objectName = 'HistoryTitleToolRight')
    ...
    def create_history_area(self):
        ...
        self.history_area.setAlignment(PyQt5.QtCore.Qt.AlignTop | PyQt5.QtCore.Qt.AlignLeft)
        title_label = PyQt5.QtWidgets.QLabel('История', objectName = 'HistoryTitle')
        title_label.setAlignment(PyQt5.QtCore.Qt.AlignTop | PyQt5.QtCore.Qt.AlignLeft)
    ...
    def add_contacts(self):
        ...
        email_label = QtWidgets.QLabel('prodamgarageaiijc@gmail.com\nVersion 1.0 ', objectName = 'InfoTitle') 
        email_label.setAlignment(PyQt5.QtCore.Qt.AlignRight)
        layout.addWidget(email_label)
        self.main_layout.addLayout(layout, 4, 1, 4, 1)

    def raise_message(self):
        msg = PyQt5.QtWidgets.QMessageBox()
        msg.setText("Уведомление")
        msg.setIcon(PyQt5.QtWidgets.QMessageBox.Question)
        msg.setStandardButtons(PyQt5.QtWidgets.QMessageBox.Ok)
        msg.setInformativeText("Данное приложение использует камеру вашего устроиства")
        msg.resize(500, 300)
        x = msg.exec_()

    def create_main_layout(self):
        self.main_layout = PyQt5.QtWidgets.QGridLayout()
        self.main_layout.setAlignment(PyQt5.QtCore.Qt.AlignTop | PyQt5.QtCore.Qt.AlignHCenter)
